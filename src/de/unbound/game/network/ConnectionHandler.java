...
public class ConnectionHandler {
	...
	TCPConnection tcpAccepter; //die neu erstellten Sockets werden in der HashMap gespeichert!
	UDPThreadReceiver 		tcpSender; //kann an alle Teilnehmer aus der HashMap TCP-Packets über Sockets verschicken
	UDPSender 	udpReceiver; //empfängt alle UDP-Packages
